...
public interface FSService
{
	...
	FSFile uploadFile(@WebParam(name="clientId") @XmlElement(required=true) long clientId, @WebParam(name="file") @XmlElement(required=true) File file) throws FSServiceException;
