...
public class QCertificate extends com.querydsl.sql.RelationalPathBase<QCertificate>
{
	...
	public final com.querydsl.sql.PrimaryKey<QCertificate> sysPk20092 = createPrimaryKey(userId);

	public final com.querydsl.sql.ForeignKey<QUser> _sysFk20112 = createForeignKey(userId, "userId");
	...
	public void addMetadata()
	{
		...
		addMetadata(userId, ColumnMetadata.named("user_id").withIndex(1).ofType(Types.BIGINT).withSize(32).notNull());
	}
