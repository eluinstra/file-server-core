...
{
	public CertificateType(int type)
	{
		super(type);
	}

	@Override
	public Class<Certificate> getReturnedClass()
	{
		return Certificate.class;
	}

	@Override
	public Certificate getValue(ResultSet rs, int startIndex) throws SQLException
	{
		return Certificate.of(rs.getBinaryStream(startIndex));
	}
