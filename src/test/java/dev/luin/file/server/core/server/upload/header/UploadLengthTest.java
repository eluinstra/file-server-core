...
public class UploadLengthTest
{
	...
	{
		assertThat(UploadLength.of(value, maxSize, () -> isUploadDeferLengthDefined)).failBecauseOf(UploadException.class)
	...
	{
		return Stream
				.of(arguments(customMaxSize, uploadDeferLengthNotDefined, "1001"), arguments(customMaxSize, uploadDeferLengthNotDefined, "9223372036854775807"));
	}
